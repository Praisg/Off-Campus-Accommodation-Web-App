						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">verify List</h4>
									<small>Here, user can select verification. Note: Status "1" sets the verification to verified.</small>
									<?php 
											if(isset($_GET['msg']))	
											echo $_GET['msg'];
								...
								<div class="card-body">
									...
									<table id="basic-datatable" class="table table-bordered table-hover">
											...
											<?php
												...
												$query=mysqli_query($conn,"select property.*, user.* from property,user where property.uid=user.uid");
												$cnt=1;
