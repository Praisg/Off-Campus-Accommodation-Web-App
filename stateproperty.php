                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['11'];?>" alt="pimage">
                                        <div class="sale bg-success text-white">For <?php echo $row['7'];?>
                                        
                                                <input type="image" name="submit" boarder="0" src="https://www.paypalobjects.com/en_US/i/btn/btn_buynow_LG.gif" alt="Buy Now"> 
                                                <img alt="" boarder="0" width="1" height="1" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" > 
