					...
					<div class="col-lg-8">
                        <div class="row">
                            ...
                            if(isset($_REQUEST['filter']))
							{
								...
								$sql="SELECT reviews.*, property.*, user.uname FROM `reviews`,`property`,`user` WHERE property.uid=user.uid and city='{$city}' and price<='{$price}' and (type<='{$type}' OR ratings>='{$ratings}')";
                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['pimage'];?>" alt="pimage">
                                        ...
                                        <div class="sale bg-success text-white">For <?php echo $row['bathroom'];?></div>
                                        <div class="price text-primary text-capitalize">$<?php echo $row['price'];?> </div>
